#!/bin/bash
# ============================================================================
# A2A-AffordGen — Train the AffordGen annotator (LoRA fine-tune)
# ----------------------------------------------------------------------------
# LoRA variant of train_affordgen_full.sh: the base VL weights are frozen, so
...
#   BASE_MODEL=/path/to/Qwen3.5-9B OUTPUT_DIR=runs/lora bash train_affordgen_lora.sh
# ============================================================================
set -e

CONDA_ENV=${CONDA_ENV:-affordance}
BASE_MODEL=${BASE_MODEL:-models/Qwen3.5-9B}
TRAIN_JSONL=${TRAIN_JSONL:-data/affordance/affordgen_train/train.jsonl}
VAL_JSONL=${VAL_JSONL:-data/affordance/affordgen_train/val.jsonl}
OUTPUT_DIR=${OUTPUT_DIR:-runs/affordgen_lora}
