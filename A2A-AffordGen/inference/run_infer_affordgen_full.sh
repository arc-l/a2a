#!/bin/bash
# ============================================================================
# A2A-AffordGen — Evaluate a FULL-finetuned AffordGen annotator
# ----------------------------------------------------------------------------
# Runs the AffordGen VLM + SAM3 interactive-click loop over a validation
# manifest and reports IoU vs. ground-truth masks. See ../README.md.
#
# Usage:
#   CKPT=/path/to/checkpoint-1200 bash run_infer_affordgen_full.sh
#   CKPT=... N_IMAGES=1167 CUDA_VISIBLE_DEVICES=0 bash run_infer_affordgen_full.sh
# ============================================================================
set -e
cd "$(dirname "$0")"
